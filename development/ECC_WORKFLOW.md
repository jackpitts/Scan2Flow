...
| [`python-patterns`](https://github.com/affaan-m/ECC/blob/main/skills/python-patterns/SKILL.md) | Use a `src/` package, explicit dependencies, and clear module responsibilities | End-user CLI isolated from developer training/evaluation; reusable inference and geometry modules remain in the runtime package |
